  ...
  return (
    <div className='flex flex-col border border-gray-300'>
      <div className='w-full'>
        <Image src={project?.primaryUrl} alt={project?.title} width={700} height={400} />
      </div>
      <div className='w-full h-full p-4 flex flex-col justify-between'>
        ...
        <div>
          ...
          <div className='relative flex items-center justify-start w-full bg-gray-200'>
            <p className={`bg-primary2 text-right h-8`} style={{ width: `${project?.fundsRaised}%` }}></p>
            <span className='absolute left-4 text-gray-800 font-semibold text-sm md:text-base'>Raised {project?.fundsRaised}%</span>
          </div>
