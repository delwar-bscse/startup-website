...
const TermsPage: React.FC = () => {
  return (
    <div className="">
      <div style={{ backgroundImage: `url(${TermsAndConditionsImg.src})` }} className="w-full text-center min-h-[200px] md:min-h-[300px] bg-cover bg-center bg-no-repeat flex items-center justify-center">
      ...
      <div className="maxWidth py-20 space-y-4 md:space-y-6">
        <p className='text-gray-500 text-sm sm:text-base'>Welcome to GiftMeIn! By using our platform, you agree to these Terms and Conditions. Please read them carefully before accessing or using our services.</p>
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">1. Introduction</h2>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">2. Definitions</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">3. Account Registration</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">4. Use of Services</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">5. Fees and Payments</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">6. Responsibilities</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">7. Limitations of Liability</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">8. Termination</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
          We reserve the right to suspend or terminate your account if we believe you have violated these Terms.
        </p>

        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">9. Governing Law</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">10. Changes to Terms</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
          We reserve the right to modify or update these Terms at any time. Any changes will be effective as soon as they
          are posted on the website.
        </p>

        <h2 className="text-xl md:text-2xl font-semibold text-gray-700">11. Contact Us</h2>
        <p className='text-gray-500 text-sm sm:text-base'>
