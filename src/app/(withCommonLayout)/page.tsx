...
const Home = async () => {
  ...
  return (
    <div className='w-full'>
      ...
      <div style={{ backgroundImage: `url(${homeHeroImg.src})` }} className='bg-cover bg-center'>
        <div className='bg-black/40'>
          <div className='maxWidth text-white py-10 md:py-24 lg:py-48 space-y-2 md:space-y-4'>
            <h2 className='text-3xl md:text-5xl lg:text-7xl font-bold max-w-[10200px]'>Empowering Small Businesses with Affordable Marketing Tools</h2>
            ...
            <Link href="/projects" className='flex justify-center items-center bg-primary text-white py-2 md:py-3  px-2 sm:px-4 lg:px-8 gap-1  sm:gap-2 lg:gap-4 rounded-md text-sm sm:text-lg lg:text-2xl tracking-wider w-50 sm:w-60 lg:w-80'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 maxWidth py-20'>
          {
            projectOverview?.map((item) => (
              <div key={item?.id} className='relative flex flex-col items-center justify-center bg-white rounded-lg shadow-lg p-8 overflow-hidden'>
                <h2 className='text-gray-600 md:text-xl lg:text-2xl font-semibold pb-4 lg:pb-8 max-w-[300px] text-center'>{item?.title}</h2>
                <p className='text-2xl md:text-3xl lg:text-4xl font-bold text-primary'>{item?.number}</p>
      ...
      <div style={{ backgroundImage: `url(${StartProjectImg.src})` }} className="w-full text-center min-h-[200px] md:min-h-[300px] bg-cover bg-center bg-no-repeat flex flex-col gap-6 items-center justify-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white">Want to Start your Project</h2>
        <Link href="/signup" className='flex justify-center items-center bg-primary2  py-1 sm:py-2 px-4 lg:px-6 gap-1  sm:gap-2 lg:gap-4 rounded-md text-sm sm:text-lg tracking-wider'>
      ...
      <div className='maxWidth flex flex-col-reverse md:flex-row gap-4 pt-12'>
        ...
        <div className='flex flex-col gap-4 items-start justify-center px-3 lg:px-20'>
          <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold'>Our best Investors</h2>
      ...
      <div className='bg-secondary py-10 md:py-20'>
        <div className='text-center space-y-2'>
          <h3 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold'>What Our Users Are Saying</h3>
          <p className='text-gray-400 lg:tracking-wide text-base'>Hear from mentees who have transformed their careers with the help of expert mentors.</p>
        </div>
        <CustomSlider />
      </div>
